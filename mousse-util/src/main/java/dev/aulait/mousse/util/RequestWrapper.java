...
public final class RequestWrapper {
  ...
  /**
   * Wraps a constructed request and a snapshot of its body for filters.
   *
   * @param request the request to send
   * @param body the same bytes used by the request's body publisher; empty for a bodyless request
   */
